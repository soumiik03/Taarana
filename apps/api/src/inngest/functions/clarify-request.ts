...
If the feature request is clear enough to be actionable by a development team, return "READY".
If the feature request needs clarification (e.g., missing use cases, ambiguous requirements, or missing technical details), ask 1 to 3 clarifying questions.
Format your output EXACTLY as a JSON array of strings containing the questions. If no questions, return an empty array [].
Example if clear: []
